...
public class Beyaz extends Fragment {
 
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.beyaz, container, false);

        Button gec=(Button) rootView.findViewById(R.id.btnBeyazGec);
