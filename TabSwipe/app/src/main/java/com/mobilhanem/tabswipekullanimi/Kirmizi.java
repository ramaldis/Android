...
public class Kirmizi extends Fragment {
 
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        View rootView = inflater.inflate(R.layout.kirmizi, container, false);

        Button gec=(Button) rootView.findViewById(R.id.btnKirmiziGec);
